...
# ---------------------------------- LICENCE  -------------------------------- #
#                                                                              #
#     Copyrighted 2011, 2012 by Håkon Strandenes, hakostra@studntnuno        #
#                                                                              # 
...
#
# See http://turbmodelslarcnasagov/naca4412sep_valhtml
#     http://enwikipediaorg/wiki/NACA_airfoil

#y_t = (t*c/02) * (02969*(x/c)**05 - 01260*(x/c) - 03516*(x/c)**2 + 02843*(x/c)**3 - 01015*(x/c)**4) 
y_t = (t*c/02) * (0.2969 * (x/c)**0.5 - 0.1260 * (x/c) - 0.3516 * (x/c)**2. + 0.2843 * (x/c)**3. - 0.1036 * (x/c)**4.) 
...
# (see comments wrt thickness calculation above)
